...
import { DepartmentUserIndex, DesktopModelCatalog, DesktopUsageEvent } from "@buildingai/db/entities";
 ...
 */
@Module({
    imports: [TypeOrmModule.forFeature([DesktopUsageEvent, DesktopModelCatalog, DepartmentUserIndex])],
    controllers: [GatewayWebController, DesktopModelCatalogConsoleController],
    providers: [GatewayService, GatewayUsageService, DesktopModelCatalogService],
    exports: [GatewayService, GatewayUsageService, DesktopModelCatalogService],
})
